public class GCRelic:BaseRelic
{
    public GCRelic():base()
    {
        ...
        descriptionsByStage[0] = "À la fin de chaque tour (ennemi ou allié), gagnez 2 d'<color=orange>Armure</color>. L'Armure n'est pas perdue quand vous jouez plusieurs tours à la suite.";
