...
public abstract class StatusEffect : StatModifier
{
    ...
    public static StatusEffect Factory(StatusType type, int value, int duration,string effectInfo="",int index=0)
    {
        StatusEffect stat = type switch
        {
            ...
            StatusType.PowerPassive=>new PowerPassiveStatus(effectInfo),
            StatusType.Infaillible=>new InfaillibleStatus(value),
            StatusType.Univers=>new UniversStatus(),
            StatusType.Megacristal=>new MegacristalStatus(),
            StatusType.Fragmentation=>new FragmentationStatus(),
            StatusType.Propulsion=>new PropulsionStatus(),
            StatusType.Empathie=>new EmpathieStatus(),
            StatusType.Avenir=>new AvenirStatus(),
            StatusType.Innocence=>new InnocenceStatus(),
            StatusType.MesuresEnvergure=>new MesuresEnvergureStatus(),
            StatusType.LamesArdentes=>new LamesArdentesStatus(value),
            StatusType.Sublimation=>new SublimationStatus(value),
            StatusType.AmeArtiste=>new AmeArtisteStatus(value),
            StatusType.GrandeOeuvre=>new GrandeOeuvreStatus(value),
            StatusType.ParcNaturel=>new ParcNaturelStatus(),
            StatusType.Pavillon=>new PavillonStatus(),
            StatusType.SuiteArithmetique=>new SuiteArithmetiqueStatus(value),
            StatusType.MurOffensif=>new MurOffensifStatus(),
            StatusType.SeptiemeVitesse=>new SeptiemeVitesseStatus(value),
            StatusType.FreinMoteur=>new FreinMoteurStatus(),
            StatusType.Galvanisation=>new GalvanisationStatus(),
            StatusType.Tenebres=>new TenebresStatus(value),
